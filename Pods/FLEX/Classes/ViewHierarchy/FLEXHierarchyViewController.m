...
+ (instancetype)delegate:(id<FLEXHierarchyDelegate>)delegate
            ...
            selectedView:(UIView *)selectedView selectedVC: (UIViewController *)selectedVC {
    return [[self alloc] initWithDelegate:delegate viewsAtTap:viewsAtTap selectedView:selectedView selectedVC:selectedVC];
}
...
- (id)initWithDelegate:(id)delegate viewsAtTap:(NSArray<UIView *> *)viewsAtTap selectedView:(UIView *)view selectedVC: (UIViewController *)selectedVC {
    self = [super init];
    if (self) {
        ...
        _treeViewController = [FLEXHierarchyTableViewController
            windows:allWindows viewsAtTap:viewsAtTap selectedView:view selectedVC:selectedVC
        ];
